        ...
        >
          <ul class="navbar-nav">
            <li class="nav-item">
              <nuxt-link
                to="/"
                :class="($route.path == '/' ? ' active' : '') + ' nav-link'"
                >使途一日あたり</nuxt-link
              >
            </li>
            <li class="nav-item">
              <nuxt-link
                to="/bubbletree"
                :class="
                  ($route.path == '/bubbletree' ? ' active' : '') + ' nav-link'
                "
                >使途別予算額</nuxt-link
              >
            </li>
            <li class="nav-item">
              <nuxt-link
                to="/about"
                :class="
                  ($route.path == '/about' ? ' active' : '') + ' nav-link'
                "
                >このサイトについて</nuxt-link
              >
            </li>
            <li class="nav-item">
              <nuxt-link
                to="/sources"
                :class="
                  ($route.path == '/sources' ? ' active' : '') + ' nav-link'
                "
                >データの出所</nuxt-link
              >
            </li>
            <li class="nav-item">
              <nuxt-link
                to="/team"
                :class="($route.path == '/team' ? ' active' : '') + ' nav-link'"
                >開発者</nuxt-link
              >
            </li>
            <li class="nav-item">
              <nuxt-link
                to="/links"
                :class="
                  ($route.path == '/links' ? ' active' : '') + ' nav-link'
                "
                >関連サイト</nuxt-link
              >
            </li>
            <li class="nav-item">
              <nuxt-link
                to="/contact"
                :class="
                  ($route.path == '/contact' ? ' active' : '') + ' nav-link'
                "
                >お問い合わせ</nuxt-link
              >
            </li>
